  ...
  render() {
    ...
    return (
      <div id="about">
        ...
        <section id="home">
          <MDBView src={"https://mdbootstrap.com/img/Photos/Others/img%20%2853%29.jpg"} fixed style={{ height: "60vh" }}>
            <MDBMask overlay="stylish-light" className="rgba-white-light d-flex justify-content-centr align-items-center">
              <MDBContainer className="h-100 d-flex justify-content-center align-items-center">
                <MDBRow>
                  <MDBCol md="12" className="mt-5 mx-auto text-center">
                    <h1 className="display-3 white-text mb-5">ABOUT <a className="white-text font-weight-bold" href="!#">US</a></h1>
                    <h5 className="text-uppercase white-text mb-5 font-weight-bold">
                      Lorem ipsum dolor sit amet consectetur. </h5>
                    <MDBBtn color="light-blue" size="lg">portfolio</MDBBtn>
        ...
        <MDBContainer>
            ...
            <MDBRow className="mb-lg-4 text-center text-md-left">
              <MDBCol lg="6" md="12" className="mb-4">
                ...
                <MDBCol md="6" className="float-right">
                  ...
                  <h6 className="font-weight-bold grey-text mb-4">Web Designer</h6>
                  <p className="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic tenetur.</p>
                  <a href="!#"><MDBIcon fab icon="facebook" className="p-2 m-2 fa-lg fb-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="twitter" className="p-2 m-2 fa-lg tw-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="dribbble" className="p-2 m-2 fa-lg dribbble-ic" /></a>
                </MDBCol>
              </MDBCol>
              <MDBCol lg="6" md="12" className="mb-4">
                <MDBCol md="6" className="float-left">
                ...
                <MDBCol md="6" className="float-right">
                  ...
                  <h6 className="font-weight-bold grey-text mb-4">Photographer</h6>
                  <p className="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic tenetur.</p>
                  <a href="!#"><MDBIcon fab icon="facebook" className="p-2 m-2 fa-lg fb-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="youtube" className="p-2 m-2 fa-lg yt-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="instagram" className="p-2 m-2 fa-lg ins-ic" /></a>
                </MDBCol>
              </MDBCol>
            </MDBRow>
            ...
            <MDBRow className="mb-lg-4 text-center text-md-left">
              <MDBCol lg="6" md="12" className="mb-4">
                ...
                <MDBCol md="6" className="float-right">
                  ...
                  <h6 className="font-weight-bold grey-text mb-4">Web Developer</h6>
                  <p className="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic tenetur.</p>
                  <a href="!#"><MDBIcon fab icon="facebook" className="p-2 m-2 fa-lg fb-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="twitter" className="p-2 m-2 fa-lg tw-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="github" className="p-2 m-2 fa-lg git-ic" /></a>
                </MDBCol>
              </MDBCol>
              <MDBCol lg="6" md="12" className="mb-4">
                <MDBCol md="6" className="float-left">
                ...
                <MDBCol md="6" className="float-right">
                  <h4><strong>Sara Melyah</strong></h4>
                  <h6 className="font-weight-bold grey-text mb-4">Front-end Developer</h6>
                  <p className="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic tenetur.</p>
                  <a href="!#"><MDBIcon fab icon="google-plus" className="p-2 m-2 fa-lg gplus-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="linkedin" className="p-2 m-2 fa-lg li-ic" /></a>
                  <a href="!#"><MDBIcon fab icon="envelope" className="p-2 m-2 fa-lg email-ic" /></a>
                </MDBCol>
              </MDBCol>
            </MDBRow>
          </section>
          ...
          <section id="products" className="text-center">
            ...
            <p className="text-center mb-5 w-responsive mx-auto lead grey-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
            <MDBRow>
